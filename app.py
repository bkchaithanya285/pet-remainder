...
with st.form("add_form"):
    ...
    email = st.text_input("✉️ Owner Email Address")
...
if records:
    ...
    st.subheader("🗑️ Delete Individual Reminder")
    for idx, rec in enumerate(records, start=1):
        ...
        with col4:
            if st.button("🗑️ Delete", key=rec["id"]):
...
if st.button("🧹 Clear All Reminders"):
    ...
    st.warning("🗑️ All reminders deleted successfully! Refresh to update.")
